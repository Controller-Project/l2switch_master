...
/**
 * AddressObserver listens to IPv6 packets to find addresses (mac, ip) and store these address
 * observations for each node-connector. These packets are returned to the network after the
